import type { IChapterRecord, INewWord, IReviewRecord, IRevisionDictRecord, IWordRecord, LetterMistakes } from './record'
import { ChapterRecord, NewWord, ReviewRecord, WordRecord } from './record'
