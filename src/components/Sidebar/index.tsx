import { isOpenDarkModeAtom, infoPanelStateAtom } from '@/store'
import { useAtom, useSetAtom } from 'jotai'
import { Keyboard, Library, BarChart3, BookMarked, Link2, Moon, Sun, Coffee, MessageSquare, Bookmark } from 'lucide-react'
